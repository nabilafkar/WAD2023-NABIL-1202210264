...
if (isset($_POST['submit'])) {
    if ($tinggi_badan > 0 && $berat_badan >0)  {
        ...
        $error_info = '!!!!!ERROR!!!! <br>inputuan tidak boleh kosong atau negatif';
        $bmi = 0;
    }
}
// **********************  3  ************************** 
...
if (isset($_POST['submit'])) {
    if ($bmi>0 && $bmi <= 18.4) {
        ...
        $status = 'ERROR';
        $error_info = 'EMPTY NUMBER/OR MINUS VALUE INPUT NO STATUS';
    }
}
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--  **********************  4  **************************     -->
                    <p> Status BMI anda  = <?php echo $status; ?></p>
                    <p> Hitungan BMI anda = <?php echo $bmi; ?></p>
